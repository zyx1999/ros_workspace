...
SDF2D::SDF2D(ros::NodeHandle& nh): nh_(nh), pointcloudTopic("pointcloud_topic"){
    ros::service::waitForService("/img2PC");
    client = nh_.serviceClient<grid_map_demos::img2PointCloud>("/img2PC");
...
void SDF2D::mapFromImage(){
    ...
    ros::ServiceClient client2 = nh_.serviceClient<grid_map_demos::sdfDetect>("/sdf_service");
    ...
    sgmap_.map.add("extrema_critical", layer_extrema_critical);
...
// void SDF2D::to2DSignedDistanceMap(){
